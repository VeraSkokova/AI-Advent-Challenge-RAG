        ...
        when (command) {
            ...
            "compare" -> {
                if (currentIndex == null) {
                    ...
                    // Обновлённые вопросы для лучшей демонстрации RAG
                    val questions = listOf(
                        // Специфичные вопросы про RAG системы
                        "Какие основные компоненты RAG системы и как они взаимодействуют?",
                        
                        // Вопросы про структуру документов (если есть в индексе)
                        "Какие модели Yandex используются для embeddings и generation?",
                        
                        // Технические детали
                        "Какой размер чанка и overlap рекомендуется для текстовых документов?",
                        
                        // Практические аспекты
                        "Какие ограничения есть у контекстного окна LLM моделей?",
